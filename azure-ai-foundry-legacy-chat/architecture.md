# Architecture — azure-ai-foundry-legacy-chat

This document describes the **classic Foundry hub** stack in `azure-ai-foundry-legacy-chat`: how Azure resources relate to each other, how Bicep and scripts deploy them, and how the Python app calls the model at runtime.
...
flowchart TB
  subgraph DevMachine["Developer machine"]
    ...
    App["azure-ai-foundry-legacy-chat/chat.py<br/>azure-ai-projects SDK"]
...
|-------|------------|------|
| **IaC** | Bicep (`azure-ai-foundry-legacy-chat/infra/bicep`) | Declarative Azure resources |
